  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Halaman Foto</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Foto
              </div>
              <!-- /.card-header -->
              <!-- form start -->
             <form role="form" action="tambah_foto.php" method="post" enctype="multipart/form-data">
							<div class="card-body">
							  <div class="form-group">
								...
								<input type="text" class="form-control" id="" placeholder="" name="JudulFoto">
							  </div>
							  <div class="form-group">
								<label for="">Deskripsi</label>
								<input type="text" class="form-control" placeholder="Deskripsi" name="DeskripsiFoto">
							  </div>
							  <div class="form-group">
           ...
           <?php
					...
					if($result) //artinya jika query berhasil dijalankan
					{
						while($data = mysqli_fetch_assoc($result))
						{
							...
							echo "<td><a href='edit_foto.php?FotoID=$fotoid' class='btn btn-block btn-outline-info btn-lg'>Edit </a>";
							echo "<a href='hapus_foto.php?id=$fotoid' class='btn btn-block btn-outline-danger btn-lg' onclick='return confirm(\"Yakin ingin menghapus foto ini?\")'>Hapus</a></td>";
							echo "</tr>";
						}
					}
					echo "</table>";
